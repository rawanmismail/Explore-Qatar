...
// Shopping & Attractions Database - Organized by Category
    ...
    malls: [
        {
            ...
            hours: "10 AM - 10 PM (Sun-Wed), 10 AM - 11 PM (Thu-Sat)",
            icon: "🏛️",
            image: "linear-gradient(135deg, #8C1D40 0%, #FFB81C 100%)",
            description: "French-inspired luxury mall with high-end brands, fine dining, and entertainment",
            highlights: ["450+ stores", "Luxury brands", "Canal walk", "Fine dining", "Entertainment zone", "IMAX cinema"],
            entry: "Free entry",
            parking: "Free parking available",
            amenities: ["Prayer rooms", "Kids play area", "Valet parking", "WiFi", "Currency exchange", "Information desk"]
        },
        {
            id: 2,
            name: "Mall of Qatar",
            ...
            icon: "🛍️",
            image: "linear-gradient(135deg, #0C616F 0%, #8C1D40 100%)",
            description: "Qatar's largest mall with 500+ stores, entertainment, and family attractions",
            highlights: ["500+ stores", "IMAX & VOX cinemas", "Theme parks", "Bowling", "Ice skating", "Food court"],
            entry: "Free entry",
            parking: "Free parking for 7000+ cars",
            amenities: ["Prayer rooms", "Baby changing", "Wheelchairs", "ATMs", "WiFi", "Concierge"]
        },
        {
            id: 3,
            name: "Villaggio Mall",
            category: "Themed Mall",
            location: "Aspire Zone",
            hours: "10 AM - 10 PM (Sun-Wed), 10 AM - 11 PM (Thu-Sat)",
            icon: "🏰",
            image: "linear-gradient(135deg, #FFB81C 0%, #0C616F 100%)",
            description: "Venice-themed mall with gondola rides through indoor canals",
            highlights: ["Gondola rides", "Indoor canal", "Theme park", "Ice rink", "200+ stores", "Venetian design"],
            entry: "Free entry",
            parking: "Ample parking",
            amenities: ["Gondolania", "Prayer rooms", "Kids zone", "Food court", "ATMs"]
        },
        {
            id: 4,
            ...
            icon: "🏢",
            image: "linear-gradient(135deg, #8C1D40 0%, #0C616F 100%)",
            description: "Modern mall with international brands and entertainment",
            highlights: ["VOX cinema", "Carrefour hypermarket", "International brands", "Family entertainment", "Food court"],
            entry: "Free entry",
            parking: "Free parking",
            amenities: ["Prayer rooms", "Play areas", "ATMs", "WiFi", "Restaurants"]
        },
        {
            id: 5,
            name: "Lagoona Mall",
            ...
            icon: "🌊",
            image: "linear-gradient(135deg, #0C616F 0%, #FFB81C 100%)",
            description: "Waterfront mall with marina views and diverse shopping",
            highlights: ["Marina views", "200+ stores", "Novo cinema", "Waterfront dining", "Fashion brands"],
            entry: "Free entry",
            parking: "Free parking",
            amenities: ["Prayer rooms", "Kids area", "Cafés", "ATMs"]
        }
    ],
    ...
    souqs: [
        {
            ...
            hours: "8 AM - 12 AM (shops vary)",
            icon: "🏪",
            image: "linear-gradient(135deg, #D4A574 0%, #8C1D40 100%)",
            description: "Historic marketplace with spices, textiles, handicrafts, and authentic Qatari atmosphere",
            highlights: ["Spice souq", "Textile market", "Falcon souq", "Traditional restaurants", "Art galleries", "Evening atmosphere"],
            entry: "Free entry",
            parking: "Paid parking nearby",
            amenities: ["Restaurants", "Cafés", "Public toilets", "ATMs", "Cultural shows"]
        },
        {
            id: 7,
            name: "Gold Souq",
            category: "Gold Market",
            location: "Inside Souq Waqif",
            hours: "9 AM - 12 PM, 4 PM - 10 PM",
            icon: "💍",
            image: "linear-gradient(135deg, #FFB81C 0%, #8C1D40 100%)",
            description: "Traditional gold and jewelry market with competitive prices",
            highlights: ["Gold jewelry", "Precious stones", "Custom designs", "Competitive pricing", "Traditional crafts"],
            entry: "Free entry",
            parking: "Shared with Souq Waqif",
            amenities: ["Expert jewelers", "Custom orders", "Bargaining accepted"]
        },
        {
            id: 8,
            name: "Souq Al Wakra",
            category: "Coastal Souq",
            location: "Al Wakra",
            hours: "8 AM - 11 PM daily",
            icon: "⛵",
            image: "linear-gradient(135deg, #0C616F 0%, #D4A574 100%)",
            description: "Restored traditional souq by the sea with authentic architecture",
            highlights: ["Seaside location", "Traditional architecture", "Handicrafts", "Restaurants", "Cultural center"],
            entry: "Free entry",
            parking: "Free parking",
            amenities: ["Waterfront", "Museums", "Cafés", "Photo spots"]
        }
    ],
    ...
    themeParks: [
        {
            ...
            hours: "10 AM - 10 PM (Sun-Thu), 10 AM - 11 PM (Fri-Sat)",
            icon: "🎮",
            image: "linear-gradient(135deg, #E53935 0%, #FFB81C 100%)",
            description: "Qatar's first indoor theme park based on Angry Birds",
            highlights: ["15+ rides", "Arcade games", "Character meet & greet", "Birthday packages", "Family fun", "Air-conditioned"],
            entry: "QR 200-250 per person",
            parking: "Mall parking",
            amenities: ["Food court", "Lockers", "Photo ops", "Gift shop"]
        },
        {
            id: 10,
            name: "Gondolania Theme Park",
            ...
            icon: "🎡",
            image: "linear-gradient(135deg, #0C616F 0%, #FFB81C 100%)",
            description: "Indoor amusement park with gondola rides",
            highlights: ["Gondola rides", "Roller coasters", "Carousel", "Arcade", "Venice theme", "Family rides"],
            entry: "Pay per ride or day pass",
            parking: "Mall parking",
            amenities: ["Food nearby", "Ice rink access", "Shopping"]
        },
        {
            id: 11,
            name: "Quest Qatar",
            ...
            location: "Doha Oasis",
            hours: "12 PM - 10 PM (Sun-Thu), 10 AM - 12 AM (Fri-Sat)",
            icon: "🎢",
            image: "linear-gradient(135deg, #FFB81C 0%, #E53935 100%)",
            description: "Adventure theme park with climbing walls and activities",
            highlights: ["Rock climbing", "Zip lines", "Rope courses", "Bowling", "Trampoline park", "Laser tag"],
            entry: "QR 250-300 per person",
            parking: "Free parking",
            amenities: ["Restaurants", "Party rooms", "Pro shop"]
        },
        {
            id: 12,
            name: "Aqua Park Qatar",
            ...
            icon: "💦",
            image: "linear-gradient(135deg, #0C616F 0%, #4CAF50 100%)",
            description: "Water park with slides, pools, and family attractions",
            highlights: ["Water slides", "Wave pool", "Lazy river", "Kids area", "Lifeguards", "Cabanas"],
            entry: "QR 150-200 per person",
            parking: "Free parking",
            amenities: ["Lockers", "Food outlets", "First aid"]
        }
    ],
    ...
    museums: [
        {
            ...
            icon: "🕌",
            image: "linear-gradient(135deg, #8C1D40 0%, #0C616F 100%)",
            description: "World-renowned museum of Islamic art by I.M. Pei",
            highlights: ["I.M. Pei architecture", "1,400 years of Islamic art", "Waterfront location", "Guided tours", "Café", "Gift shop"],
            entry: "QR 50 adults, Free under 16",
            parking: "Free parking",
            amenities: ["Audio guides", "Wheelchair access", "Restaurant", "Library"]
        },
        {
            id: 14,
            name: "National Museum of Qatar",
            ...
            icon: "🏛️",
            image: "linear-gradient(135deg, #A12852 0%, #D4A574 100%)",
            description: "Stunning museum inspired by desert rose crystal",
            highlights: ["Jean Nouvel design", "Qatar history", "Interactive exhibits", "Multimedia displays", "Restaurant", "Desert rose architecture"],
            entry: "QR 50 adults, Free under 16",
            parking: "Free parking",
            amenities: ["Café", "Gift shop", "Tours", "Accessibility"]
        },
        {
            id: 15,
            name: "Mathaf: Arab Museum of Modern Art",
            ...
            icon: "🎨",
            image: "linear-gradient(135deg, #FFB81C 0%, #8C1D40 100%)",
            description: "Leading institution for modern Arab art",
            highlights: ["Free admission", "Contemporary Arab art", "Rotating exhibitions", "Educational programs", "Museum shop"],
            entry: "Free",
            parking: "Free parking",
            amenities: ["Workshops", "Library", "Café"]
        },
        {
            id: 16,
            name: "Fire Station Artist in Residence",
            category: "Art Gallery",
            location: "Al Rumeilah",
            hours: "9 AM - 5 PM (Sun-Thu)",
            icon: "🔥",
            image: "linear-gradient(135deg, #E53935 0%, #8C1D40 100%)",
            description: "Contemporary art space in converted fire station",
            highlights: ["Free entry", "Artist studios", "Exhibitions", "Workshops", "Café", "Contemporary art"],
            entry: "Free",
            parking: "Street parking",
            amenities: ["Café", "Outdoor space", "Gallery shop"]
        }
    ],
    ...
    outdoor: [
        {
            ...
            icon: "🌳",
            image: "linear-gradient(135deg, #4CAF50 0%, #0C616F 100%)",
            description: "Qatar's largest park with lake, playgrounds, and walking paths",
            highlights: ["Free entry", "Lake views", "Playgrounds", "Cycling paths", "Duck feeding", "Picnic areas"],
            entry: "Free",
            parking: "Free parking",
            amenities: ["Kiosks", "Toilets", "WiFi", "Jogging track"]
        },
        {
            id: 18,
            name: "Oxygen Park",
            ...
            icon: "⚽",
            image: "linear-gradient(135deg, #4CAF50 0%, #FFB81C 100%)",
            description: "Massive park with sports facilities and playgrounds",
            highlights: ["Free entry", "Running tracks", "Cycling paths", "Playgrounds", "Sports courts", "Picnic areas"],
            entry: "Free",
            parking: "Free parking",
            amenities: ["Cafeteria", "Toilets", "Sports equipment"]
        },
        {
            id: 19,
            name: "Al Bidda Park",
            ...
            icon: "⛲",
            image: "linear-gradient(135deg, #0C616F 0%, #4CAF50 100%)",
            description: "Waterfront park with fountains and skyline views",
            highlights: ["Free entry", "Water fountains", "Skyline views", "Walking paths", "Playgrounds", "Evening shows"],
            entry: "Free",
            parking: "Paid parking nearby",
            amenities: ["Cafés", "Toilets", "Photo spots"]
        },
        {
            id: 20,
            name: "Katara Cultural Village",
            ...
            location: "Katara",
            hours: "24/7 (venues vary)",
            icon: "🎭",
            image: "linear-gradient(135deg, #8C1D40 0%, #FFB81C 100%)",
            description: "Cultural hub with galleries, theaters, and beach",
            highlights: ["Free access", "Art galleries", "Amphitheater", "Beach", "Restaurants", "Events"],
            entry: "Free (some venues charged)",
            parking: "Free parking",
            amenities: ["Restaurants", "Galleries", "Opera house", "Beach"]
        }
    ],
    ...
    entertainment: [
        {
            ...
            icon: "🎪",
            image: "linear-gradient(135deg, #FF6B9D 0%, #FFB81C 100%)",
            description: "Family entertainment center with games and rides",
            highlights: ["Arcade games", "Soft play", "Bumper cars", "Ball pits", "Birthday parties", "Prize games"],
            entry: "Token-based pricing",
            parking: "Mall parking",
            amenities: ["Café", "Party rooms", "Lockers"]
        },
        {
            id: 22,
            name: "Virtuocity",
            ...
            icon: "🎮",
            image: "linear-gradient(135deg, #8C1D40 0%, #0C616F 100%)",
            description: "Virtual reality gaming center",
            highlights: ["VR experiences", "Racing simulators", "Adventure games", "Latest technology", "Group packages"],
            entry: "QR 100-200 per session",
            parking: "Mall parking",
            amenities: ["Snack bar", "Lounge area"]
        },
        {
            id: 23,
            name: "Snow Dunes Qatar",
            category: "Indoor Snow Park",
            location: "Doha Festival City (Planned)",
            hours: "10 AM - 10 PM",
            icon: "❄️",
            image: "linear-gradient(135deg, #0C616F 0%, #FFFFFF 100%)",
            description: "Indoor snow park with skiing and snowboarding",
            highlights: ["Real snow", "Ski slopes", "Snowboarding", "Penguin encounters", "Snow play area", "Equipment rental"],
            entry: "QR 200-300 per person",
            parking: "Mall parking",
            amenities: ["Winter gear rental", "Café", "Lessons"]
        }
    ],
    ...
    sports: [
        {
            ...
            icon: "⚽",
            image: "linear-gradient(135deg, #8C1D40 0%, #4CAF50 100%)",
            description: "Iconic FIFA World Cup 2022 stadium",
            highlights: ["World Cup venue", "Stadium tours", "Museum", "Sports events", "Architecture", "Photo opportunities"],
            entry: "Tour prices vary",
            parking: "Large parking area",
            amenities: ["Museum", "Gift shop", "Café"]
        },
        {
            id: 25,
            name: "Aspire Academy",
            ...
            icon: "🏃",
            image: "linear-gradient(135deg, #4CAF50 0%, #8C1D40 100%)",
            description: "World-class sports training facility",
            highlights: ["Olympic facilities", "Swimming pools", "Running track", "Sports programs", "Fitness center"],
            entry: "Membership or day passes",
            parking: "Free parking",
            amenities: ["Restaurants", "Pro shop", "Physiotherapy"]
        },
        {
            id: 26,
            name: "Losail International Circuit",
            category: "Racing Circuit",
            location: "Losail",
            hours: "Event days",
            icon: "🏎️",
            image: "linear-gradient(135deg, #E53935 0%, #2c2c2c 100%)",
            description: "F1 Grand Prix and MotoGP racing venue",
            highlights: ["F1 races", "MotoGP", "Track days", "Racing events", "VIP experiences", "Championships"],
            entry: "Event ticket prices vary",
            parking: "Event parking",
            amenities: ["VIP lounges", "Food courts", "Merchandise"]
        }
    ]
};
...
function displayAllPlaces() {
    displayCategory('mallsGrid', places.malls);
    displayCategory('souqsGrid', places.souqs);
    displayCategory('themeParksGrid', places.themeParks);
    displayCategory('museumsGrid', places.museums);
    displayCategory('outdoorGrid', places.outdoor);
    displayCategory('entertainmentGrid', places.entertainment);
    displayCategory('sportsGrid', places.sports);
}
...
function displayCategory(gridId, items) {
    ...
    items.forEach(place => {
        ...
        const freeBadge = place.entry === "Free" || place.entry.toLowerCase().includes("free") ? 
            '<div class="free-badge">FREE</div>' : '';
        
        card.innerHTML = `
            <div class="place-card-image" style="background: ${place.image};">
                <span style="font-size: 5rem;">${place.icon}</span>
                ${freeBadge}
            </div>
            <div class="place-card-content">
                ...
                <div class="place-highlights">
                    ${place.highlights.slice(0, 4).map(h => `<span class="highlight-tag">${h}</span>`).join('')}
                </div>
                <div class="place-card-footer">
                    <button class="btn-view-place" onclick="event.stopPropagation(); openPlaceModal(this)">View Details</button>
                </div>
            </div>
        `;
...
function openPlaceModal(place) {
    ...
    document.getElementById('modalPlaceImage').innerHTML = `<span style="font-size: 6rem;">${place.icon}</span>`;
    document.getElementById('modalPlaceImage').style.background = place.image;
    ...
    document.getElementById('modalHours').textContent = `🕐 ${place.hours}`;
    ...
    document.getElementById('detailParking').textContent = `Parking: ${place.parking}`;
    document.getElementById('detailHours').textContent = place.hours;
    document.getElementById('detailEntry').textContent = place.entry;
    
    const amenitiesDiv = document.getElementById('detailAmenities');
    amenitiesDiv.innerHTML = `
        <ul style="list-style: none; padding: 0;">
            ${place.amenities.map(item => `<li style="padding: 0.3rem 0;">✓ ${item}</li>`).join('')}
        </ul>
    `;
    
    const mapsQuery = encodeURIComponent(place.name + ' ' + place.location + ' Qatar');
    document.getElementById('directionsLink').href = `https://www.google.com/maps/search/?api=1&query=${mapsQuery}`;
